...
func (s *Account) battleCardSourcesLocked(profiles []gamestate.TeamBattleRewardProfile, allowedGroups map[int]struct{}) (map[int][]howToGetCardEntry, error) {
	...
	add := func(reward gamestate.Reward, entry howToGetCardEntry) {
