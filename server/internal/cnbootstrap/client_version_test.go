...
func TestCNClientVersionGateBeforeAccountCreation(t *testing.T) {
	for _, version := range []string{"", "6.0.2", "6.0.3", "6.0.4", "5.9.99", "6.0", "garbage", "6.0.03", "6.0.5.0", "6.0.65536"} {
		...
		cnBootstrapLogin(nil, "127.0.0.1", 26020, CDNConfig{}, resourceVersionNamespace(nil, nil, nil), "images")(response, httptest.NewRequest(http.MethodPost, "/loginSDK.php", strings.NewReader(string(body))))
