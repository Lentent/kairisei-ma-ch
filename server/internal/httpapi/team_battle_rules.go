...
func (s *store) teamBattleEntryRulesForBoss(bossID int) (teamBattleEntryRules, bool) {
	s.mu.RLock()
	defer s.mu.RUnlock()
	return s.teamBattleEntryRulesForBossLocked(bossID)
}

func (s *store) teamBattleEntryRulesForBossLocked(bossID int) (teamBattleEntryRules, bool) {
