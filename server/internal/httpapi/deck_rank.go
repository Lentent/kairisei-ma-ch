...
func (s *store) deckRankLocked(deck deckInfo, inventory map[int64]int) int8 {
...
func (s *store) rankedDecksLocked(decks []deckInfo) []deckInfo {
...
func (s *store) rankInventoryLocked() map[int64]int {
...
func (s *store) refreshDeckRanksLocked() {
...
func (s *store) maximumDeckRank() int {
	s.mu.RLock()
	defer s.mu.RUnlock()
