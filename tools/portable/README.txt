...
这些配置保存后重启保留；已有兑换次数保留，正在进行的战斗沿用原掉落计划。
「公告与奖励」可修改公告、签到奖励、新手毕业邮件、剧情首通水晶、看板价格和购买开关。
普通签到每7次循环，新手签到只发一轮，累计登录独立发放；修改配置不清除已领取记录。
新手毕业邮件可选卡牌、素材、道具和货币等，完成整个新手训练后发送一次；默认关闭，已完成训练的账号不补发。
关闭看板购买不回收已有角色；无需重新同步 CDN。
